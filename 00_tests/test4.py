...
def get_attractions_for_traveler(traveler):
    ...
    interests_string = ("Hi {}, we think you'll like these places around {}: ".format(traveler_name, traveler_destination))
...
print(get_attractions_for_traveler(['Antoine Ratat', 'Cairo, Egypt', ['historical site', 'museum']]))